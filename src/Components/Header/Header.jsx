...
function Header(){
    ...
    return(
        <>
        <div onClick={()=>setIsHeaderOpen(!isHeaderOpen)} className=" relative z-40 lg:hidden "><IoBookmarkSharp className="absolute text-red-600 text-7xl right-2"/><HiOutlineDotsVertical className="absolute text-3xl right-8 mt-2 text-white"/></div>
        <div className={` z-30 flex flex-col gap-5 py-8  lg:flex-row bg-white lg:bg-[#201E43]  p-5 text-[#7e858f] lg:text-white justify-between items-center md:px-20 xl:px-48 transition-all duration-200  absolute left-0 right-0 lg:relative  ${isHeaderOpen?"opacity-100":" opacity-0"} lg:opacity-100 ` }>
            ...
            <div className="flex flex-col sm:flex-row  gap-8 text-sm" >
                ...
                <div className="flex items-center gap-2">
                    ...
                    <a href="mailto:support@amazonslogistic.com"  className="leading-4">
                        <h3 className="font-semibold">Email Us</h3>
                        <p>support@amazonslogistic.com</p>
                    </a>
                </div>
